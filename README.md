...
To train models, the code found in `fine_tune_bilstm_sentence.py` or `fine_tune_crf_morpheme_sentence.py` can be
adjusted.
...
In order to customise the training and tuning process, different arguments can be passed to `train_all` and
`tune_model`.
...
- Pretorius, L. and Bosch, S. (2018). ZulMorph: Finite state morphological analyser for Zulu (Version 20190103)
  \[Software]. Web demo at https://portal.sadilar.org/FiniteState/demo/zulmorph/
