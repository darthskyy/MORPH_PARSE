...
from common import (AnnotatedCorpusDataset, tune_model, tokenize_into_morphemes, EmbedSingletonFeature, split_sentences,
                    train_all, tokenize_into_chars, EmbedBySumming)
...
def final_train():
    ...
    cfg = {
        'lr': 0.000954635878440661,
        'weight_decay': 6.0833284971598955e-09,
        'hidden_dim': 1024,
        'dropout': 0.3,
        'batch_size': 1,
        'epochs': {
    ...
    train_all(model, splits, feature_level, cfg, use_testset=True, langs=["SS", "NR"])
